...
class TestReview(unittest.TestCase):
    ...
    def setUp(self):
         self.new_review = Review(movie_id=12345,title='Review for movies',image_url="https://image.tmdb.org/t/p/w500/jdjdjdjn",movie_review='This movie is the best thing since sliced bread')
    ...
    def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_review.image_url,"https://image.tmdb.org/t/p/w500/jdjdjdjn")
